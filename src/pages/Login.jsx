      ...
      <div className="flex items-center justify-center h-screen">
        <div className="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
          <div className="mb-8 flex justify-center">
            <span className="bg-[#20b2a6]">
              <img
                className="w-24 border rounded-full"
                src="https://media.istockphoto.com/id/1461045367/vector/musical-notes-on-white-background-vector-stock-illustration.jpg?s=612x612&w=0&k=20&c=JU544s8_Q5TBjKW7tjmBky2h12b1oyZW0YPclgAxhdw="
                alt=""
              />
            </span>
          </div>
          ...
          <button
            className="mt-5 w-full border p-2 bg-[#20b2a6] text-white rounded-[4px] hover:bg-[#82abae] scale-105 duration-300"
            type="submit"
          >
            Sign in
          </button>
